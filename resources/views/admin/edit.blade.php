...
<h4 class="pb-3"> admin Edit task <span class="badge bg-info"> {{$task->title}}</span></h4>
</div>
...
<div class="clearfix"></div>
  ...
  <div class="mb-3">
   ...
   <a href="{{ route('index') }}" class="btn btn-secondary m-2"><i class="fa fa-arrow-left"></i>Cancel</a>
